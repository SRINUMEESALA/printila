...
const Footer = () => (
    <div className="footerParentCon d-flex flex-wrap text-light p-3">
        <div className="col-lg-5 col-6">
            <h1 className="pt-2 pb-2 h4 "><span className="websiteNativeColor">ANGRY</span>BAAZ</h1>
            <ul className="list-unstyled itemsOfFooter">
                <li>AngryBaaz provides progressie and affordable healthcare,accessible on mobil and online for everyone.</li>
